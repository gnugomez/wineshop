...
public class Wine {
    ...
    private String name;
    private String year;
    @PositiveOrZero(message = ValidationErr.negativeErr)
    @Min(value = 0, message = ValidationErr.ratingIntervalErr)
    @Max(value = 5, message = ValidationErr.ratingIntervalErr)
