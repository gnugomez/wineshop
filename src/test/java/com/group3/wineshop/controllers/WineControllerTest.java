...
class WineControllerTest {
    ...
    void setupWineryService() {
        when(wineService.getById(anyLong())).thenReturn(new Wine(2L, "Get Wine", "2022", 4.5,
                2, 27.38, "4", "3", 1, 1, 1));
        ...
        when(wineService.save(any(Wine.class))).thenReturn(new Wine(5005L, "Save Wine", "2022", 4.5,
                2, 27.38, "4", "3", 1, 1, 1));
    ...
    public void findOneTest() throws Exception {
        mockMvc.perform( MockMvcRequestBuilders
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.name").value("Get Wine"));
    }
    ...
    {
        mockMvc.perform(delete("/api/wines/1")
                        .contentType(MediaType.APPLICATION_JSON))
